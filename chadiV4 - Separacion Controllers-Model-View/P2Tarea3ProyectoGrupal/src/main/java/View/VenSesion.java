...
Mongo mongo;
    ...
    // Pasa las credenciales directamente al método buscarUsuario
    Document result = mongo.buscarUsuario();
    if (result != null) {
        String nombreEncontrado = result.getString("Usuario");
    ...
    */
    ...
    public javax.swing.JPasswordField JLPClave;
